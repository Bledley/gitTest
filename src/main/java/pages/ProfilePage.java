...
public class ProfilePage {
   ...
   //public SelenideElement setEmoji = $(xpath("//div[@class='d-flex flex-items-center no-underline js-predefined-user-status-message']"));
    ...
    public SelenideElement statusAfter = $(xpath("//div[@class=' user-status-message-wrapper f6 lh-condensed ws-normal pt-3']"));
    public SelenideElement activeStatusbtn = $(xpath("//div[@class=' user-status-message-wrapper f6 lh-condensed ws-normal pt-3']"));
